...
if not df_geral_periodo.empty:
    ...
    # ── BLOCO 1: DF regiões (esq) + Gráfico Top 10 piores (dir) na mesma linha
    ...
    with col_reg_graf:
        # Top 10 piores regiões por sinistralidade — barras horizontais escala Reds
    ...
    # ── BLOCO 2: DF por UF (esq) + Mapa de calor (dir) na mesma linha
    st.write("---")
    ...
    with col_uf_df:
        # DF por UF — mesmas colunas do df de Região, ordenado por maior sinistralidade
    ...
    with col_uf_mapa:
        # Mapa de calor — cor por sinistralidade da UF
